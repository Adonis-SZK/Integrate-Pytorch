...
#YOLO5: loss_param--- [每层输出权重,2*[边框权重,置信度权重,类别权重]]---[[1/3,1/3],[0.3,0.4,0.3],[0.4,0.4,0.3]]
import torch
...
class YOLO5(torch.nn.Module):
    ...
    def forward(self,input1):
        ...
        return [output_2.reshape(-1,3,(self.args.OD_class+ 5),img_len//16,img_len//16).permute(0,1,3,4,2),\
