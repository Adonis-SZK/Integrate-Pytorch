...
class SCINet(nn.Module):
    def __init__(self,  args, hid_size=1, num_decoder_layer=1, concat_len=0, groups=1, kernel=5, dropout=0.5,
                 single_step_output_One=0, positionalE=False, modified=True, RIN=False):
        super(SCINet, self).__init__()
        self.input_dim = len(args.TSF_column)
        self.input_len = args.TSF_input
        self.output_len = args.TSF_output
        self.num_levels = args.model_param[0]
        num_stacks=args.model_param[1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_param',default=[3,1], type=list)
    parser.add_argument('--TSF_input', default=96, type=int)
    parser.add_argument('--TSF_output', default=48, type=int)
    parser.add_argument('--TSF_column', default=[1, 3], type=list)
